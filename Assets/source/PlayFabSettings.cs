...
namespace PlayFab
{
    public class PlayFabSettings
    {
        ...
        public static Dictionary<string, string> RequestGetParams
        {
            get { return staticSettings.RequestGetParams; }
        }

        [Obsolete("Moved to PlayFabSettings.staticSettings.ProductionEnvironmentUrl")]
        public static string ProductionEnvironmentUrl
        {
            get { return staticSettings.ProductionEnvironmentUrl; }
            set { staticSettings.ProductionEnvironmentUrl = value; }
        }
        ...
        public static string DeveloperSecretKey { get { return staticSettings.DeveloperSecretKey; } set { staticSettings.DeveloperSecretKey
 = value; } }
#endif
